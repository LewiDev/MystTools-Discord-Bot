...
export default {
    ...
    execute: async (message: Message, args: string[]) => {
        ...
        let sentMessage = await message.channel.send({ embeds: [arenaEmbedAndRow[0] as EmbedBuilder], components: [arenaEmbedAndRow[1] as ActionRowBuilder<StringSelectMenuBuilder>] })
