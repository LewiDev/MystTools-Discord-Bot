...
export default {
    name: "channels",
    description: "Sends channels help message",
    execute: async (message: Message, args: string[]) => {
        ...
        let sentMessage = await message.channel.send({ embeds: [channelsEmbedAndRow[0] as EmbedBuilder], components: [channelsEmbedAndRow[1] as ActionRowBuilder<StringSelectMenuBuilder>] })
